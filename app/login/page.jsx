    ...
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 20 }}>
      <div style={{ width: '100%', maxWidth: 380 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 36 }}>
          <span style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 900, fontSize: 26, color: MINT, letterSpacing: '-0.01em' }}>
            Provnr
          </span>
        ...
        <div style={{ background: CARD, border: `1px solid ${BORDER}`, borderRadius: 16, padding: '28px 28px' }}>
          <h1 style={{ fontFamily: 'Nunito, sans-serif', fontWeight: 800, fontSize: 18, color: '#f0f0ea', marginBottom: 24 }}>
            Sign in
          </h1>

          <form onSubmit={handleLogin}>
            <div style={{ marginBottom: 16 }}>
              <label style={{ display: 'block', fontSize: 11, color: '#666', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.07em', marginBottom: 7 }}>
                Email
              </label>
              <input
                type="email"
        ...
        <p style={{ textAlign: 'center', color: '#333', fontSize: 11, marginTop: 20 }}>
          registro.provnr.com · Internal use only
        </p>
      </div>
    </div>
  );
